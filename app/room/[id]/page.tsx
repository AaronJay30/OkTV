                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <ScrollArea
                                        ...
                                        orientation="both"
                                    >
                                        <div className="space-y-3 pr-4 min-w-full">
                                            {searchResults.map((result) => (
                                                <motion.div
                                                    ...
                                                    className="flex items-start bg-gray-700/50 rounded-lg p-3 hover:bg-gray-700 transition-colors w-full"
                                                    style={{
                                                        minWidth: "350px",
                                                    }}
                                                >
                                                    ...
                                                    <div className="flex flex-col flex-grow min-w-0">
                                                        <div className="flex justify-between items-center w-full">
                                                            <p
                                                                className="text-sm pr-3 break-words"
                                                                style={{
                                                                    wordBreak:
                                                                        "break-word",
                                                                }}
                                                            ...
                                                            <Button
                                                                ...
                                                                className="bg-purple-600 hover:bg-purple-500 shrink-0 ml-3 h-8 w-8 p-0 rounded-full"
                                                            >
                                ...
                                >
                                    ...
                                    >
                                        {queue.length > 0 ? (
                                            <div className="space-y-3 pr-4 min-w-full bg-gray-800/50">
                                                <AnimatePresence>
                                                    {queue.map(
                                                        (song, index) => (
                                                            <motion.div
                                                                ...
                                                                className="flex items-start bg-gray-700/50 rounded-lg p-3 group w-full"
                                                                style={{
                                                                    minWidth:
                                                                        "350px",
                                                                }}
                                                            >
                                                                <div className="flex-shrink-0 mr-4">
                                                                    <div className="w-6 h-6 flex items-center justify-center bg-gray-600 rounded text-xs font-medium mb-1">
                                                                        {index +
                                                                            1}
                                                                    </div>
                                                                    <img
                                                                    ...
                                                                    <div className="flex justify-between items-center w-full">
                                                                        ...
                                                                        {(isAdmin ||
                                                                            ...
                                                                            <Button
                                                                                ...
                                                                                className="opacity-0 group-hover:opacity-100 text-red-500 hover:text-red-400 hover:bg-transparent shrink-0 h-8 w-8 p-0 rounded-full ml-3"
                                                                            >
                                ...
                                >
                                    ...
                                    >
                                        {users.length > 0 ? (
                                            <div className="space-y-2 pr-4 min-w-full bg-gray-800/50">
                                                {users.map((user) => (
                                                    <div
                                                        key={user.id}
                                                        className="flex items-center bg-gray-700/50 rounded-lg p-3 w-full"
                                                        style={{
                                                            minWidth: "350px",
                                                        }}
                                                    >
                                                        <div className="w-8 h-8 rounded-full bg-purple-600 flex items-center justify-center mr-4 flex-shrink-0">
                                                            {user.name
                                                                .charAt(0)
                                                                .toUpperCase()}
                                                        </div>
